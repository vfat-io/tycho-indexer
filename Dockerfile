...
ENTRYPOINT ["/opt/tycho-indexer/tycho-indexer --endpoint https://mainnet.eth.streamingfast.io:443 \
    --module map_changes \
    --spkg /opt/tycho-indexer/substreams/substreams-ethereum-ambient-v0.3.0.spkg"]