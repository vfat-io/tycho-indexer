...
function usage()
{
   ...
   optional arguments:
     ...
     -s, --snapshot            if set, the image tag will have a snapshot tag (postfixed by --SNAPSHOT.XXXXXXX)
   Git tags
   --------
...
REPOSITORY="827659017777.dkr.ecr.eu-central-1.amazonaws.com/tycho-indexer"
