-- REMOVE balance_float from account_balance table
-- Step 1: Drop the NOT NULL constraint
ALTER TABLE account_balance ALTER COLUMN balance_float DROP NOT NULL;

-- Step 2: Remove the balance_float column
ALTER TABLE account_balance DROP COLUMN IF EXISTS balance_float;
