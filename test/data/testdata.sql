...
INSERT INTO protocol_type("name", "type", "implementation", "attribute_schema")
    VALUES ('uniswap-v2:swap', 'swap', 'custom', '{"properties": {"fee": {"type": "integer"}}}'),
...
INSERT INTO protocol_component(chain_id, external_id, attributes, created_at, protocol_type_id, protocol_system_id)
    VALUES (1, 'uniswap_1', '{"fee": 3000}', '2021-01-10 14:00:00', 1, 1),
...
INSERT INTO protocol_state("tvl", "inertias", "state", "modify_tx", "valid_from", "protocol_component_id")
    VALUES (1000, ARRAY[25, 50], '{"reserve0": 500, "reserve1": 1000}', 1, '2021-01-10 14:00:00', 1),
...
INSERT INTO "contract"("chain_id", "title", "address", "creation_tx", "created_at", "deleted_at")
    VALUES (1, 'ambient', E'\\xDEADBEEF69', 1, '2021-01-10 13:00:00', NULL),
...
INSERT INTO "token"("contract_id", "symbol", "decimals", "tax", "gas")
    VALUES (3, 'DAI', 18, NULL, ARRAY[21000, 21000, 21000, 60000]),
...
INSERT INTO contract_balance("balance", "contract_id", "modify_tx", "valid_from", "valid_to")
    VALUES (E'\\xde0b6b3a7640000', 1, 1, '2021-01-10 13:00:00', '2021-01-10 14:00:00'),
...
INSERT INTO contract_code("code", "hash", "contract_id", "modify_tx", "valid_from", "valid_to")
    VALUES (E'\\x00', E'\\x00', 1, 1, '2022-01-10 13:00:00+00', NULL),
...
INSERT INTO contract_storage(slot, value, contract_id, modify_tx, valid_from, valid_to)
    VALUES (E'\\x1234', E'\\x6789', 1, 1, '2022-01-10 13:00:00', '2022-01-10 14:00:00'),
...
INSERT INTO protocol_calls_contract(protocol_component_id, contract_id, valid_from)
    VALUES (3, 1, '2021-01-10 13:00:00'),
